                     ...
                     DISPLAY_PROGRESS(display_progress)
{
  ...
  {
    Console::PrintMessage("WARNING!\nFrom GeneticAlgorithm constructor:\n");
    Console::PrintMessage("One or more parameter values are invalid!\n");
  ...
  {
    Console::PrintMessage("WARNING!\nFrom GeneticAlgorithm constructor:\n");
    Console::PrintMessage("There are not enough horses for this number of players!\n");
    Console::WaitForEnterButton();
    exit(EXIT_FAILURE);
  }
  ...
  {
    Console::PrintMessage("WARNING!\nFrom GeneticAlgorithm constructor:\n");
    Console::PrintMessage("The number of individuals in generation shall be at least\n");
    Console::PrintMessage("two times greater than the number of players!\n");
    Console::WaitForEnterButton();
    exit(EXIT_FAILURE);
  }
  ...
  if (Game::MAX_DICE_NUMBER != 6)
  {
    ...
    Console::PrintMessage("The Game::MAX_DICE_NUMBER shall be equal to 6!\n");
    Console::PrintMessage("Debug the Game.cpp file!\n");
    Console::WaitForEnterButton();
    exit(EXIT_FAILURE);
  }
}
...
bool GeneticAlgorithm::SaveResult(const vector<double> & eval_fun, const char * file_name) const
{
